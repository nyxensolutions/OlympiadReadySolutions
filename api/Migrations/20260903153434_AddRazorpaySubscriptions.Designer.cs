...
namespace OlympiadReady.Api.Migrations
{
    ...
    [Migration("20260903153434_AddRazorpaySubscriptions")]
    partial class AddRazorpaySubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlympiadReady.Api.Data.Entities.PaymentTransaction", b =>
                {
            ...
            modelBuilder.Entity("OlympiadReady.Api.Data.Entities.PhysicalRewardClaim", b =>
                {
                    ...
                    b.HasIndex("UserId", "RewardType");

                    b.ToTable("PhysicalRewardClaims", (string)null);
                });
            ...
            modelBuilder.Entity("OlympiadReady.Api.Data.Entities.School", b =>
                {
                    ...
                    b.Property<DateTime?>("PilotEndsAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OlympiadReady.Api.Data.Entities.User", b =>
                {
                    ...
                    b.Property<decimal>("AiDollarsSpent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,4)")
                        .HasDefaultValue(0m);

                    b.Property<DateTime>("AiPeriodStart")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValueSql("GETUTCDATE()");
                    ...
                    b.Property<int>("FreeAiTutorChatsUsed")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("SchoolJoinedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OlympiadReady.Api.Data.Entities.UserSeenQuestion", b =>
                {
                    ...
                    b.HasIndex("UserId", "QuestionBankId")
                        .IsUnique();

                    b.ToTable("UserSeenQuestions", (string)null);
                });
            ...
            modelBuilder.Entity("OlympiadReady.Api.Data.Entities.User", b =>
                {
                    b.HasOne("OlympiadReady.Api.Data.Entities.School", "School")
                        .WithMany("Students")
