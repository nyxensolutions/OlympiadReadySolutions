      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-10 mx-auto max-w-2xl rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 p-px shadow-lg">
          <div className="rounded-2xl bg-white px-6 py-5 text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-orange-600 mb-1">🎉 Offer Extended!</p>
            <p className="text-xl font-extrabold text-slate-900">40% off all subscriptions &amp; PDF downloads</p>
            <p className="mt-1 text-sm text-slate-500">Extended till 10 September 2026 — Olympiad exams start in October, prep now!</p>
          </div>
        </div>
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-slate-600">
            The average Olympiad tutor charges ₹600–₹1,200 per hour. OlympiadReady costs just <strong>₹77 per subject per month</strong> (offer extended to 10 Sept) — that&apos;s unlimited practice, every day.
          </p>
        </div>
