      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-slate-600">
            The average Olympiad tutor charges ₹600–₹1,200 per hour. OlympiadReady costs just <strong>₹129 per subject per month</strong> — that&apos;s unlimited practice, every day.
          </p>
        </div>
