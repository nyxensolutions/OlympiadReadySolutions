...
function PracticePapersBody() {
  ...
  // ── Paid download (₹19 single August offer, or bundle discount — each click = fresh payment) ───────
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                a: "Each payment gives you a fresh 50-question download. Price: ₹29 each for 1-2 papers, ₹25 each for 3-5, and ₹20 each for 6+. Add multiple subjects to a bundle and download as a ZIP in one go.",
              },
              {
